...
// optional string name = 4;
inline bool LoginResponse::_internal_has_name() const {
  bool value = (_has_bits_[0] & 0x00000001u) != 0;
  return value;
}
inline bool LoginResponse::has_name() const {
...
inline const std::string& LoginResponse::name() const {
  // @@protoc_insertion_point(field_get:auth.LoginResponse.name)
...
void LoginResponse::set_name(ArgT0&& arg0, ArgT... args) {
 ...
 name_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:auth.LoginResponse.name)
}
inline std::string* LoginResponse::mutable_name() {
  std::string* _s = _internal_mutable_name();
  // @@protoc_insertion_point(field_mutable:auth.LoginResponse.name)
  return _s;
}
...
inline std::string* LoginResponse::release_name() {
  // @@protoc_insertion_point(field_release:auth.LoginResponse.name)
...
inline void LoginResponse::set_allocated_name(std::string* name) {
  ...
  // @@protoc_insertion_point(field_set_allocated:auth.LoginResponse.name)
}

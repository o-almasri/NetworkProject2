...
static ::PROTOBUF_NAMESPACE_ID::Metadata file_level_metadata_login_5frequest_2eproto[1];
static constexpr ::PROTOBUF_NAMESPACE_ID::EnumDescriptor const** file_level_enum_descriptors_login_5frequest_2eproto = nullptr;
static constexpr ::PROTOBUF_NAMESPACE_ID::ServiceDescriptor const** file_level_service_descriptors_login_5frequest_2eproto = nullptr;

const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_login_5frequest_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  PROTOBUF_FIELD_OFFSET(::auth::LoginRequest, requestid_),
...
const char descriptor_table_protodef_login_5frequest_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n\023login_request.proto\022\004auth\"B\n\014LoginRequ"
  "est\022\021\n\trequestId\030\001 \002(\005\022\r\n\005email\030\002 \002(\t\022\020\n"
  "\010password\030\003 \002(\t"
  ;
static ::PROTOBUF_NAMESPACE_ID::internal::once_flag descriptor_table_login_5frequest_2eproto_once;
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_login_5frequest_2eproto = {
  false, false, 95, descriptor_table_protodef_login_5frequest_2eproto, "login_request.proto", 
  &descriptor_table_login_5frequest_2eproto_once, nullptr, 0, 1,
  schemas, file_default_instances, TableStruct_login_5frequest_2eproto::offsets,
  file_level_metadata_login_5frequest_2eproto, file_level_enum_descriptors_login_5frequest_2eproto, file_level_service_descriptors_login_5frequest_2eproto,
};
PROTOBUF_ATTRIBUTE_WEAK const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable* descriptor_table_login_5frequest_2eproto_getter() {
  return &descriptor_table_login_5frequest_2eproto;
}

// Force running AddDescriptors() at dynamic initialization time.
PROTOBUF_ATTRIBUTE_INIT_PRIORITY static ::PROTOBUF_NAMESPACE_ID::internal::AddDescriptorsRunner dynamic_init_dummy_login_5frequest_2eproto(&descriptor_table_login_5frequest_2eproto);
namespace auth {

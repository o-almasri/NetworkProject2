...
const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_register_5fresponse_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  PROTOBUF_FIELD_OFFSET(::auth::RegisterResponse, name_),
  1,
  2,
  3,
  0,
...
static const ::PROTOBUF_NAMESPACE_ID::internal::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, 10, -1, sizeof(::auth::RegisterResponse)},
};
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_register_5fresponse_2eproto = {
  false, false, 274, descriptor_table_protodef_register_5fresponse_2eproto, "register_response.proto", 
    ...
    switch (tag >> 3) {
      ...
      case 4:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 34)) {
          ...
          #ifndef NDEBUG
          ::PROTOBUF_NAMESPACE_ID::internal::VerifyUTF8(str, "auth.RegisterResponse.name");
          #endif  // !NDEBUG
          CHK_(ptr);
        } else
          goto handle_unusual;

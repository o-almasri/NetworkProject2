...
inline int32_t LoginRequest::_internal_requestid() const {
  return requestid_;
}
inline int32_t LoginRequest::requestid() const {
  // @@protoc_insertion_point(field_get:auth.LoginRequest.requestId)
  return _internal_requestid();
}
inline void LoginRequest::_internal_set_requestid(int32_t value) {
  _has_bits_[0] |= 0x00000004u;
  requestid_ = value;
}
inline void LoginRequest::set_requestid(int32_t value) {
